        ...
        <div className="row">
          <div className="col-lg-7 col-xl-7 col-md-12 col-sm-12 col-xs-12">
            <div className="container">
              <div className="row justify-content-center">
                <div className="BACK">
                  <Link to="/InfluencePageOffering">
                    <img src={back} className="BACK-IMG" alt="" />
                  </Link>
                </div>
                <div className="col-9">
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <input
                      ...
                      className="form-control input-spcl input-header "
              ...
              <div className="row justify-content-center" >
                <div className="col-9">
                  <div className="row file-wrapper ">
                    <div class="file btn-lg btn-info">
                      Add Photo
                      <input
                        type="file"
                        name="image"
              ...
              <div className="row justify-content-center">
                <textarea
                  ...
                  className="form-control input-spcl input-desc "
          ...
          <div
            className="col-lg-5 col-xl-5 col-md-12 col-sm-12 col-xs-12"
