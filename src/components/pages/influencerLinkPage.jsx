...
function InfluencerLinkPage() {
  ...
  const onAddNewAccount = () => {
    ...
    axios
      .post("api/social/adduserSocialAccounts", userSocial)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
  ...
  useEffect(() => {
    axios
      .get("api/social/getSocialAccounts/" + jwtDecode())
      .then((res) => {
  ...
  const addNewSocialProfile = () => {
    axios
      .post("api/social/addNewLink/" + socialId, {
        title: socialTitle,
        link: socialLink,
      })
      .then((res) => {
  ...
  const submitNewLink = () => {
    ...
    axios
      .put("api/social/update/" + objId + "/" + linkId, {
        link: popUpEditLink,
      })
      .then((res) => {
        console.log(res);
  ...
  const updateProfile = () => {
    ...
    axios
      .put("api/users/updateprofile/" + jwtDecode(), newData)
      .then((res) => {
        console.log(res);
        successfullyUpdateProfile();
  ...
  return (
    <div>
      {!localStorage.usertoken ? (
        <div className="container-fluid mb-5">
            ...
            >
              <div className="col-6 mt-2 mb-2">
                <Avatar
                  alt="Remy Sharp"
                  src={Face}
                  className={[classes.large, "profile_pic"]}
                />
              </div>
              <div className="col-6 mt-2 mb-2 text-center ">
                <br />
                <b className="ml-4 top-name ">Name</b>
                <br />
                <div
                  style={{
                    textAlign: "center",
                ...
                >
                  <b className="atTheRate">@username</b>
                </div>
                <br />
                <div
                  style={{
                ...
                >
                  <button to="/InfluencePageOffering" className="my-button">
                    <Link
                      to="/InfluencePageOffering"
                      style={{ color: "#fff" }}
                      className="my-btn-text"
                    >
                      Offerings
                    </Link>
                  </button>
          ...
          <div className='cust-content' >
            <div className="linkedSocialApps">YouTube</div>
            <br />
            <div className="linkedSocialApps">Instagram</div>
            <br />
            <div className="linkedSocialApps">Art Instagram</div>
            <br />
            <div className="linkedSocialApps">Tik Tok</div>
          </div>
        </div>
      ) : (
              ...
              <div className="linkedSocialApps">
                <div className="row">
                  <div className="col-9 text-center">
                    <div className="linkedSocialApps">{item.title}</div>
                  </div>
                  <div className="col-3">
                    <button
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            To Add your Social Account Add the title and the url of your
            account.
          </DialogContentText>
          <TextField
            autoFocus
